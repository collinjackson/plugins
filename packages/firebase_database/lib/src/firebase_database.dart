...
class FirebaseDatabase {
  ...
  /// goOffline call.
  void goOnline() {
    _channel.invokeMethod("FirebaseDatabase#goOnline");
  }

  /// Shuts down our connection to the Firebase Database backend until goOnline
  /// is called.
  void goOffline() {
    _channel.invokeMethod("FirebaseDatabase#goOffline");
  }
  ...
  void purgeOutstandingWrites() {
    _channel.invokeMethod("FirebaseDatabase#purgeOutstandingWrites");
  }
}
